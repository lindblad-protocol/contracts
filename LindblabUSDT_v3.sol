...
contract LindblabUSDT {
    ...
    constructor(address _usdt, address _pyco, address _treasury) {
        owner = msg.sender;
        usdt = _usdt;
        pyco = _pyco;
        treasury = _treasury;
    ...
    function withdraw(WithdrawParams calldata p) external notPaused {
        ...
        require(IERC20(usdt).transfer(p.toWallet, p.amount), "Transfer failed");
    ...
    function emergencyWithdraw() external onlyOwner {
        ...
        IERC20(usdt).transfer(owner, bal);
    }
}
